...
:root{--ink:#0a1020;--navy:#0b1f3a;--blue:#2563eb;--green:#10b981;--bg:#f7f9fc;--muted:#667085;--line:#e6eaf0;--soft:#eef4ff;--shadow:0 18px 50px rgba(15,23,42,.08)}
*{box-sizing:border-box}html{scroll-behavior:smooth}body{margin:0;background:var(--bg);color:var(--ink);font-family:'DM Sans',sans-serif}a{text-decoration:none;color:inherit}
nav{position:sticky;top:0;z-index:20;background:rgba(247,249,252,.92);backdrop-filter:blur(18px);border-bottom:1px solid var(--line)}.nav{width:min(1180px,92%);height:72px;margin:auto;display:flex;align-items:center;justify-content:space-between;gap:18px}.logo{font-family:'Manrope';font-size:25px;font-weight:800;letter-spacing:-1px;color:var(--navy)}.dot{color:var(--blue)}.links{display:flex;gap:22px;color:#475467;font-weight:600}.actions{display:flex;gap:10px;align-items:center}
.wrap{width:min(1180px,92%);margin:auto;padding:30px 0 60px}.hero{position:relative;overflow:hidden;display:grid;grid-template-columns:1.15fr .85fr;gap:34px;align-items:center;background:linear-gradient(135deg,#07182f,#0b2c59 55%,#174c87);border-radius:32px;padding:68px;color:#fff;box-shadow:0 24px 80px rgba(8,31,66,.18)}.hero:before{content:'';position:absolute;width:280px;height:280px;border-radius:50%;background:#2dd4bf;opacity:.2;right:-90px;top:-90px}.hero h1{font-family:'Manrope';font-size:58px;line-height:1.02;letter-spacing:-2.5px;margin:18px 0}.hero p{font-size:19px;line-height:1.65;color:#d9e7f7;margin:0 0 28px}.eyebrow{display:inline-flex;padding:8px 12px;border-radius:999px;background:rgba(255,255,255,.09);border:1px solid rgba(255,255,255,.18);font-size:13px;font-weight:700;color:#dcecff}.heroBtns{display:flex;gap:12px;flex-wrap:wrap}.heroPanel{position:relative;background:rgba(255,255,255,.08);border:1px solid rgba(255,255,255,.15);border-radius:24px;padding:20px}.stat{display:flex;justify-content:space-between;padding:16px;border-bottom:1px solid rgba(255,255,255,.12)}.stat:last-child{border:0}.stat b{font-family:'Manrope';font-size:23px}.stat span{color:#cae0f6}
.btn{display:inline-flex;align-items:center;justify-content:center;border:0;border-radius:12px;padding:12px 18px;background:var(--blue);color:white;font-weight:700;cursor:pointer;transition:.2s}.btn:hover{transform:translateY(-1px);box-shadow:0 10px 24px rgba(37,99,235,.2)}.green{background:var(--green)}.light{background:#fff;color:var(--navy)}.dark{background:var(--navy)}.ghost{background:var(--soft);color:var(--blue)}
.trust{display:grid;grid-template-columns:repeat(3,1fr);gap:14px;margin-top:20px}.trust>div,.card{background:#fff;border:1px solid var(--line);border-radius:18px;padding:20px;box-shadow:0 8px 30px rgba(15,23,42,.035)}.trust b{display:block;margin-bottom:5px}.trust span,.muted{color:var(--muted)}
.section{margin-top:52px}.head{display:flex;justify-content:space-between;align-items:end;gap:20px;margin-bottom:20px}.head h2,h1,h2,h3{font-family:'Manrope';letter-spacing:-.5px}.head h2{font-size:34px;margin:0}.head p{margin:5px 0 0;color:var(--muted)}.grid{display:grid;grid-template-columns:repeat(auto-fit,minmax(235px,1fr));gap:16px}.two{display:grid;grid-template-columns:1fr 1fr;gap:20px}.role{min-height:170px;transition:.2s}.role:hover{transform:translateY(-3px);box-shadow:var(--shadow)}.icon{width:42px;height:42px;border-radius:12px;background:linear-gradient(135deg,#e9f0ff,#eafcf8);display:grid;place-items:center;margin-bottom:14px;font-size:20px}.role h3{margin:0 0 8px}.role p{font-size:14px;line-height:1.55;color:var(--muted);margin:0}
label{display:block;font-weight:700;margin:14px 0 7px;font-size:14px}input,select,textarea{width:100%;padding:13px 14px;border:1px solid #d5dbe5;border-radius:12px;background:#fff;font:inherit;outline:0}input:focus,select:focus,textarea:focus{border-color:#7aa2f7;box-shadow:0 0 0 4px rgba(37,99,235,.09)}textarea{min-height:105px}.form{max-width:760px;margin:20px auto}.pill{display:inline-flex;padding:7px 10px;border-radius:999px;background:#eaf9f3;color:#067647;font-size:12px;font-weight:700}.score{font-family:'Manrope';font-size:34px;font-weight:800;color:var(--blue)}.item{border:1px solid var(--line);border-radius:15px;padding:15px;margin:10px 0;background:#fff}.flash{background:#eef6ff;border:1px solid #cfe2ff;color:#194d86;padding:12px;border-radius:12px;margin:14px 0}.footer{text-align:center;border-top:1px solid var(--line);padding:28px;color:#7a8595;font-size:13px}
@media(max-width:900px){.hero{grid-template-columns:1fr;padding:42px}.hero h1{font-size:46px}.heroPanel,.links{display:none}.trust{grid-template-columns:1fr}}@media(max-width:720px){.two{grid-template-columns:1fr}.hero{padding:30px}.hero h1{font-size:38px}.nav{height:64px}.wrap{padding-top:18px}.head{align-items:flex-start;flex-direction:column}}'''
...
def home():
    icons=['◎','✦','⌘','↗','◉','✓','◆']
    groups=''.join('<div class="card role"><div class="icon">%s</div><h3>%s</h3><p>%s</p></div>'%(icons[i%7],c,' • '.join(rs[:5])+(' • more' if len(rs)>5 else '')) for i,(c,rs) in enumerate(ROLES.items()))
    return page('Home','''<section class="hero"><div><span class="eyebrow">✓ Proof-first business growth network</span><h1>Find the right expert. Grow with confidence.</h1><p>DIGIBIZ helps businesses discover verified marketers, creators, developers, promoters, influencers, CAs and agencies — matched by capability, relevance and evidence.</p><div class="heroBtns"><a class="btn green" href="/register/business">I’m a Business Owner</a><a class="btn light" href="/register/pro">I’m a Professional / Agency</a><a class="btn" href="/login?admin=1">Admin Login</a></div></div><div class="heroPanel"><div class="stat"><span>Expert categories</span><b>7</b></div><div class="stat"><span>Verification model</span><b>Proof-first</b></div><div class="stat"><span>Matching</span><b>Role-based</b></div></div></section><section class="trust" id="how"><div><b>01 — Prove</b><span>Experts submit role-specific work, credentials or audience proof.</span></div><div><b>02 — Verify</b><span>DIGIBIZ reviews evidence and assigns a transparent score.</span></div><div><b>03 — Match</b><span>Businesses see relevant experts instead of endless profiles.</span></div></section><section class="section" id="roles"><div class="head"><div><h2>Every role your business may need</h2><p>Marketing, creative, technology, promotion, influencers and professional services in one network.</p></div></div><div class="grid">'''+groups+'''</div></section><section class="section" id="trust"><div class="card"><div class="head"><div><h2>Built around trust, not profile hype.</h2><p>A marketer proves strategy. An influencer proves audience quality. A promoter proves field capability. A CA proves applicable credentials.</p></div><a class="btn dark" href="/register/business">Find an Expert</a></div></div></section>''')
...
def login():
    ...
    return page('Login','<div class="form card"><h1>Welcome back</h1><p class="muted">Access your DIGIBIZ workspace.</p><form method="post"><label>Email</label><input type="email" name="email" required><label>Password</label><input type="password" name="password" required><br><button class="btn dark">Login</button></form>'+note+'</div>')
...
def business():
    ...
    return page('Business Dashboard','<div class="head"><div><h2>%s</h2><p>Business Owner Dashboard</p></div><a class="btn green" href="/requirement">+ Post Requirement</a></div><div class="two"><div class="card"><h3>Start with a business goal</h3><p class="muted">Tell DIGIBIZ what you need and we’ll surface relevant experts.</p></div><div class="card"><h3>Your Requirements</h3>%s</div></div>'%(b['business_name'],rows))
...
def matches(rid):
    ...
    ps=con().execute('SELECT u.name,p.* FROM pros p JOIN users u ON u.id=p.user_id WHERE p.primary_role=? OR p.category=? ORDER BY p.score DESC',(r['required_role'],r['category'])).fetchall();cards=''.join('<div class="card"><span class="pill">%s</span><h3>%s</h3><p><b>%s</b></p><div class="score">%s/100</div><p class="muted">%s</p><form method="post" action="/contact/%s/%s"><button class="btn green">Request Contact</button></form></div>'%(p['status'],p['name'],p['primary_role'],p['score'],p['pricing'] or 'Pricing on request',rid,p['user_id']) for p in ps) or '<div class="card"><h3>No matching experts yet</h3><p class="muted">This role has no matching profiles in the current MVP.</p></div>'
    return page('Matches','<div class="head"><div><h2>Recommended Experts</h2><p>%s</p></div><a class="btn ghost" href="/business">Back</a></div><div class="grid">%s</div>'%(r['required_role'],cards))
...
@auth('admin')
def admin():
    b=con().execute("SELECT count(*) c FROM users WHERE role='business'").fetchone()['c'];p=con().execute("SELECT count(*) c FROM users WHERE role IN ('professional','agency')").fetchone()['c'];r=con().execute('SELECT count(*) c FROM requirements').fetchone()['c'];a=con().execute("SELECT count(*) c FROM assessments WHERE status='Pending'").fetchone()['c'];pending=con().execute("SELECT a.*,u.name,p.category,p.primary_role FROM assessments a JOIN users u ON u.id=a.pro_id JOIN pros p ON p.user_id=u.id WHERE a.status='Pending' ORDER BY a.id DESC").fetchall();queue=''.join('<div class="card"><h3>%s</h3><p class="muted">%s • %s</p><p>%s</p><form method="post" action="/review/%s"><label>Score</label><input type="number" name="score" min="0" max="100" value="80"><br><button class="btn green">Verify</button></form></div>'%(x['name'],x['category'],x['primary_role'],x['response'],x['id']) for x in pending) or '<div class="card"><p class="muted">No pending reviews.</p></div>'
    return page('Admin Dashboard','<div class="head"><div><h2>DIGIBIZ Admin</h2><p>Marketplace and verification overview.</p></div></div><div class="grid"><div class="card"><h3>Business Owners</h3><div class="score">%s</div></div><div class="card"><h3>Professionals / Agencies</h3><div class="score">%s</div></div><div class="card"><h3>Requirements</h3><div class="score">%s</div></div><div class="card"><h3>Pending Reviews</h3><div class="score">%s</div></div></div><section class="section"><div class="head"><div><h2>Verification Queue</h2><p>Review evidence and assign a score.</p></div></div>%s</section>'%(b,p,r,a,queue))
...
def review(aid):
    ...
    score=max(0,min(100,int(request.form['score'])));status='Verified Pro' if score>=85 else 'Skill Verified' if score>=65 else 'Needs Improvement';con().execute("UPDATE assessments SET score=?,status='Reviewed' WHERE id=?",(score,aid));con().execute('UPDATE pros SET score=?,status=? WHERE user_id=?',(score,status,a['pro_id']));con().commit();flash('Verification updated.');return redirect('/admin')
